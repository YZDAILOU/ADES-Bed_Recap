...
shareLinkInputLabel.textContent = 'Id of generated sharing link (default: share-link)';
...
function initTests() {
    ...
    const criterias = [
        [
            `It should generate a link with the key <b>${randomKey}</b> as <b style="color: red">query parameter</b> that retrieves the generated modules`,
            allowUserDefinedSharingId,
        ],
        [
            `It should <b  style="color: red">disable</b> user defined controls when loading`,
            userDefinedControlsShouldBeDisabled,
        ],
        [
            `It should <b style="color: red">NOT</b> allow re-use of <b>${randomKey}</b> again since it has yet expired`,
            duplicateKeyShouldReject,
        ],
        [
            `It should delete <b>${expiringRandomKey}</b> which is added with expiry duration of 5s and allow re-insertion`,
